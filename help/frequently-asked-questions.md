...
1. **Kan tjänsten installeras lokalt?**
   <p>Adobe utbildar AI- och ML-algoritmer i tjänsten Automated Forms Conversion med jämna mellanrum med nya data för att förbättra konverteringsnoggrannheten. De uppdaterade algoritmerna distribueras till konverteringstjänsten som körs på Adobe Cloud med regelbundna intervall. Tjänstens alla kunder drar nytta av de uppdaterade algoritmerna. Central driftsättning i molnet passar bäst för tjänsten Automated Forms Conversion för att kontinuerligt lära sig och leverera förbättringar till alla kunder.</p> 
    <p>Tjänsten konverterar tomma formulär till anpassningsbara formulär. Tjänsten stöder inte ifyllda formulär och extrahering av data från ifyllda formulär. Ta bort data från ifyllda formulär och ta bort eller vitlista egenutvecklad information från formulären innan formulären skickas till tjänsten för konvertering</p> <br>

1. **Stöder tjänsten alla format i PDF-formulär? Vilka språk stöds?**
...
1. **Kan tjänsten konvertera ett Microsoft Word-formulär till anpassningsbara formulär?**
   ...
   1. Använd Adobe Acrobat för att [konvertera de genererade PDF-formulären till ifyllbara PDF-formulär](https://helpx.adobe.com/acrobat/how-to/convert-word-excel-paper-pdf-forms.html).
...
1. **Kan tjänsten konvertera inskannade pappersblanketter och färglagda blanketter till anpassningsbara blanketter?**
   <p>Tjänsten kan konvertera PDF-formulär till anpassningsbara formulär. Tjänsten stöder inte skannade eller ifyllda formulär. Andra begränsningar finns i artikeln <a href="known-issues.md">Kända fel</a> .</p> <br>

1. **Kan tjänsten konvertera ett skannat formulär eller endast en bild av ett formulär till ett anpassat formulär?**
   <p>Tjänsten stöder inte konvertering av skannade formulär eller en bild av ett formulär till ett anpassat, körklart formulär. Du kan dock använda Adobe Acrobat för att konvertera bilden av ett formulär till ett PDF-formulär. Använd sedan tjänsten för att konvertera PDF-formuläret till ett anpassat formulär. Använd alltid en högkvalitativ bild av formuläret för konvertering i Acrobat. Det förbättrar kvaliteten på konverteringen.</p> <br>
...
De vanligaste orsakerna till att konverteringen misslyckas är:</p>
   * Skyddade PDF-formulär tillhandahålls för konverteringen. Använd inte lösenordsskyddade eller skyddade PDF-formulär för konvertering.
...
1. **Påverkar användningen av anpassade teckensnitt konverteringen?**
   <p>När ett icke-interaktivt PDF-formulär konverteras till ett anpassningsbart formulär bäddas teckensnitten in i PDF-formuläret för att förbättra konverteringskvaliteten. Stödet för inbäddning av teckensnitt är begränsat till icke-interaktiva PDF-formulär. För att optimera konverteringen av AcroForm- och XFA-baserade PDF-formulär används grundteckensnitt.</p> 
